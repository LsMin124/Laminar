...
public class EquipmentController {
  ...
  public ResponseEntity<EquipmentResponse> create(@Valid @RequestBody CreateRequest request) {
    EquipmentEntity created =
        service.create(
            request.name(), request.description(), request.location(), request.defaultLogColumns());
  ...
  public ResponseEntity<EquipmentResponse> update(
      @PathVariable UUID equipmentId, @Valid @RequestBody UpdateRequest request) {
    EquipmentEntity updated =
        service.update(
            equipmentId,
            request.name(),
            request.description(),
  ...
  public ResponseEntity<EquipmentResponse> toggleActive(
      @PathVariable UUID equipmentId, @RequestBody ToggleRequest request) {
