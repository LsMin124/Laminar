...
public enum WorkspaceRole {
  ...
  public static WorkspaceRole fromDbValue(String dbValue) {
    return Arrays.stream(values())
        ...
        .findFirst()
        .orElseThrow(() -> new IllegalArgumentException("Unknown workspace role: " + dbValue));
  }

  @Converter(autoApply = true)
  public static class WorkspaceRoleConverter implements AttributeConverter<WorkspaceRole, String> {
