...
public enum SyncDirection {
  ...
  public static SyncDirection fromDbValue(String dbValue) {
    return Arrays.stream(values())
        ...
        .findFirst()
        .orElseThrow(() -> new IllegalArgumentException("Unknown sync direction: " + dbValue));
  }

  @Converter(autoApply = true)
  public static class SyncDirectionConverter implements AttributeConverter<SyncDirection, String> {
