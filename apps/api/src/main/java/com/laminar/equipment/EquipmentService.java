 ...
 *
 * 모든 워크스페이스 멤버 read·write, OWNER만 일부 수정 (활성화 토글 등 정책 — 필요 시 service에서 강제).
 */
@Service
public class EquipmentService {
    ...
    public EquipmentEntity create(
        ...
        equipment.setDefaultLogColumns(defaultLogColumns == null ? new ArrayList<>() : defaultLogColumns);
