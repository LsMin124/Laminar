...
public class PerpetualColumnId implements Serializable {
    ...
    public UUID getColumnDefinitionId() { return columnDefinitionId; }
    public void setColumnDefinitionId(UUID columnDefinitionId) { this.columnDefinitionId = columnDefinitionId; }
