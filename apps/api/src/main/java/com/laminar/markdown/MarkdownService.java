 ...
 *
 * 파이프라인:
 *   1. commonmark + gfm-tables 확장 → unsafe HTML
 *   2. OWASP Java HTML Sanitizer (Formatting + Links + Blocks + Tables + Images)
 *   3. 250KB byte 한도 (attrs.long_body_override 옵트인 추가 검증은 서비스 레이어 별도)
 *
 * Spec §11.4: XSS 방지 + 사용자 마크다운 신뢰 0.
 */
@Service
