 ...
 *
 * 멤버 제거 시 즉시 revoke 위해 DB 세션 사용 (Spec §5.4). 만료 정리 cron이 deleteByExpiresAtBefore 사용.
 */
public interface SessionSystemRepository extends JpaRepository<SessionEntity, UUID>, SystemRepository {
