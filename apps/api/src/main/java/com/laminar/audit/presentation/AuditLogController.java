...
public class AuditLogController {
  ...
  public ResponseEntity<List<AuditLogDtos.AuditLogResponse>> listRecent(
    ...
    return ResponseEntity.ok(service.listRecent(limit).stream().map(this::toResponse).toList());
  }
  ...
  public ResponseEntity<List<AuditLogDtos.AuditLogResponse>> listInRange(
    ...
    return ResponseEntity.ok(service.listInRange(from, to).stream().map(this::toResponse).toList());
  }
