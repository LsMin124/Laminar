 ...
 *
 * <p>expand(dtstart, windowStart, windowEnd) — dtstart부터 starting하여 window 안의 occurrence date 반환.
 */
public record Rrule(RruleFrequency freq, int interval, Integer count, LocalDate until) {
