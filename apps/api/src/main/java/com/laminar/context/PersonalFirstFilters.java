 ...
 *
 * <p>엔티티는 @FilterDef + @Filter로 이 이름을 참조. HibernateFilterActivator가 매 Session 시작 시
 * WorkspaceContext에 맞춰 활성화 + 파라미터 바인딩.
 *
 * <p>- PERSONAL_FIRST: workspace_id + user_id 이중 필터 (Personal-First) - WORKSPACE_SHARED:
 * workspace_id 단일 필터 (audit, equipment, outbox 등)
 *
