...
/**
 * 독립 화이트보드 — Personal-First. 타임라인/캘린더(카드·관계)와 무관한 자유 노드·엣지 캔버스. 노드/엣지는 hard-delete (스크래치 공간). 엣지는
 * 노드 FK CASCADE로 정리.
 */
@Service
public class WhiteboardService {
  ...
  @Transactional
  public WhiteboardEdgeEntity createEdge(
      UUID boardId, UUID fromNodeId, UUID toNodeId, String label) {
    WorkspaceContext ctx = requirePersonalWritable();
