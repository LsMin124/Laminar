 ...
 * 장비 담당자 N:N (Spec Q12).
 *
 * OWNER만 임명·해임 가능. 담당자는 해당 장비 정책 (점검, 사용 승인 등)을 추가로 수정 가능 — 권한 검사는 호출 측.
 */
@Service
public class EquipmentAdminService {
    ...
    public EquipmentAdminService(EquipmentAdminRepository adminRepo, EquipmentRepository equipmentRepo) {
