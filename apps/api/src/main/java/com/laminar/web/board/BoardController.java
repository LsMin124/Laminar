...
public class BoardController {
    ...
    @PostMapping
    public ResponseEntity<BoardDtos.BoardResponse> create(@Valid @RequestBody BoardDtos.CreateRequest request) {
        BoardEntity board = boardService.create(
                request.name(),
                request.slug(),
                request.defaultView(),
                request.iconName(),
    ...
    public ResponseEntity<List<BoardDtos.BoardResponse>> list() {
        List<BoardDtos.BoardResponse> response = boardService.listActive().stream()
                .map(this::toResponse)
                .toList();
    ...
    public ResponseEntity<BoardDtos.BoardResponse> update(
            ...
            @Valid @RequestBody BoardDtos.UpdateRequest request) {
        BoardEntity updated = boardService.update(
                boardId,
                request.name(),
                request.defaultView(),
                request.iconName(),
