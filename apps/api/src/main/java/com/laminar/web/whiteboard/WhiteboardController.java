...
public class WhiteboardController {
  ...
  public ResponseEntity<WhiteboardDtos.NodeResponse> createNode(
      @PathVariable UUID boardId, @Valid @RequestBody WhiteboardDtos.CreateNodeRequest request) {
  ...
  public ResponseEntity<WhiteboardDtos.NodeResponse> updateNode(
      @PathVariable UUID nodeId, @Valid @RequestBody WhiteboardDtos.UpdateNodeRequest request) {
    WhiteboardNodeEntity node =
        service.updateNode(
            nodeId,
            request.text(),
  ...
  public ResponseEntity<WhiteboardDtos.EdgeResponse> createEdge(
      @PathVariable UUID boardId, @Valid @RequestBody WhiteboardDtos.CreateEdgeRequest request) {
    WhiteboardEdgeEntity edge =
        service.createEdge(boardId, request.fromNodeId(), request.toNodeId(), request.label());
